      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {MOCK_EMPLOYEES.length} membri &middot;{" "}
            {MOCK_EMPLOYEES.filter((e) => e.is_active).length} activi
          </p>
        </div>
          ...
          <div key={emp.id} className="rounded-xl border bg-white overflow-hidden">
            ...
            <div className="p-5">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className={`h-3 w-3 rounded-full ${emp.is_active ? "bg-emerald-500" : "bg-gray-300"}`} />
              </div>
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-lg p-2 text-center ${
                          hasSchedule ? "bg-blue-50" : "bg-gray-50"
                        }`}
                      >
