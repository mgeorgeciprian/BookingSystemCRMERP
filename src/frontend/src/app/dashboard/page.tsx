    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Miercuri, 19 Februarie 2026 &middot; Bine ai revenit, Andreea!
          </p>
        </div>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={s.today.appointments}
          sub={`${s.today.completed} finalizate, ${s.today.in_progress} in curs`}
          color="blue"
        />
        <StatCard
          label="Venit azi"
          value={`${s.today.revenue_today.toLocaleString("ro-RO")} RON`}
          sub={`Estimat: ${s.today.revenue_expected.toLocaleString("ro-RO")} RON`}
          color="green"
        />
        <StatCard
          label="Venit luna"
        ...
        <StatCard
          ...
          sub={`${s.month.appointments} programari in feb.`}
          color="amber"
        />
      </div>
      ...
      <div className="mb-6 rounded-xl border bg-white p-5">
        ...
        <div className="flex items-end gap-3 h-40">
          {s.revenue_chart.map((m) => {
            const maxRev = Math.max(...s.revenue_chart.map((x) => x.revenue));
      ...
      <div className="grid gap-6 lg:grid-cols-3">
            ...
            {MOCK_APPOINTMENTS_TODAY.map((apt) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: MOCK_EMPLOYEES.find(
                      (e) => e.id === apt.employee_id
                    )?.color,
                  }}
                />
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border bg-white p-5">
            <h3 className="mb-4 text-sm font-semibold text-gray-900">
              Notificari trimise (feb.)
            </h3>
            <div className="space-y-3">
              {s.channel_breakdown.map((ch) => (
              ...
              <div className="border-t pt-2 flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-gray-900">
                  {s.channel_breakdown.reduce((a, b) => a + b.cost, 0).toFixed(2)} EUR
                </span>
              </div>
            </div>
          </div>
